# 🤖 Starting with LLM-based agents with Langflow

This repository will help you dive into **LLM‑based autonomous agents** even if you have *zero* coding experience. 
The repository provides additional information and hands-on exercises for the **[KIDA Online-Workshop: AI-based autonomous agents - What, why and how?](https://www.kida-bmel.de/veranstaltungen/archiv)** done on 07.04.2025
